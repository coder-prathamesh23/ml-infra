resource "aws_sagemaker_domain" "this" {
  ...
  default_space_settings {
    ...
    space_storage_settings {
      default_ebs_storage_settings {
        default_ebs_volume_size_in_gb = var.default_space_default_ebs_volume_size_in_gb
        maximum_ebs_volume_size_in_gb = var.default_space_maximum_ebs_volume_size_in_gb
      }
    }
  }
  ...
  default_user_settings {
    ...
    studio_web_portal = {
      status = var.default_user_studio_web_portal_status
    }
